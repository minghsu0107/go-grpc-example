...
func (x *GreetWithDeadlineResponse) Reset() {
	*x = GreetWithDeadlineResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_greet_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetWithDeadlineResponse) Descriptor() ([]byte, []int) {
	return file_proto_greet_proto_rawDescGZIP(), []int{10}
}
...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x0a, 0x16, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x74, 0x69, 0x6d, 0x65, 0x73,
	...
	0x6c, 0x74, 0x32, 0x87, 0x03, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76,
...
var file_proto_greet_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_proto_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_greet_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_greet_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
